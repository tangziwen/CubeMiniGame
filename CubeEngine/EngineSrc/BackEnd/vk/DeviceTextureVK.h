...
public:
	...
	void initEmpty(size_t w, size_t h, ImageFormat format, TextureRoleEnum rtFlag = TextureRoleEnum::AS_COLOR, TextureUsageEnum texUsage = TextureUsageEnum::SAMPLE_ONLY,int mipLevels = 1, int initLayout = -1);
