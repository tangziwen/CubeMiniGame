...
CylinderPrimitive::CylinderPrimitive(float radiusTop, float radiusBottom, float height)
{
	...
	m_topBottomMaterial = MaterialInstance::createFromMaterial("ModelStd");
...
void CylinderPrimitive::submitDrawCmd(DrawPassTypeMask drawPassMask, RenderQueue * queues, int requirementArg)
{
	if(getIsVisible())
	{
