...
namespace tzw
{
	void LoadWorldUI::drawIMGUI(bool* isOpen)
	{
		...
		ImGui::Begin(TRC(u8"读取世界"),isOpen, ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoCollapse);
