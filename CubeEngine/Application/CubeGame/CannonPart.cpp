...
void CannonPart::drawInspect()
{
	...
	if(ImGui::RadioButton(TRC(u8"抛射物"),m_fireMode == 0)) m_fireMode = 0;
	if(ImGui::RadioButton(TRC(u8"激光"),m_fireMode == 1)) m_fireMode = 1;
	if(ImGui::RadioButton(TRC(u8"脉冲激光"),m_fireMode == 2)) m_fireMode = 2;
