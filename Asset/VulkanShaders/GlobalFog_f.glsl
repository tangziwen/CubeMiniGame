...
{
	float fogFactor = getFogFactorByDist(t_shaderUnifom.fog_near, t_shaderUnifom.fog_far, getDist(t_shaderUnifom.TU_camInfo.x, t_shaderUnifom.TU_camInfo.y, depth));
